...
export default function Content() {
  ...
  return (
    <div className="pt-[64px] h-auto  ">
      <Row>
        <Col className="bg-black pt-[50px] z-50  fixed " span={4}>
          <Box
            onMouseEnter={() => setHandShowScroll(true)}
            onMouseLeave={() => setHandShowScroll(false)}
            style={slidebarStyles}
          >
            <Box className="flex-col text-lg ">
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-4 bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl ">
                <Box>
                  <svg
              ...
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height={24}
              ...
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                ...
                <Box>
                  <p className="text-white">Subcribes</p>
                </Box>
              </Box>
            </Box>
            <hr className="  #222222  mt-4 " />
            <Box className="flex-col mt-4 text-lg ">
              <Box className="flex ml-[15px] gap-4">
                <Box>
                  <p className="text-white font-bold ml-3">You</p>
                </Box>
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <Box className="flex-col mt-4 text-lg ">
              <Box className="flex gap-4">
                <Box>
                  <p className="text-white font-bold ml-[30px]">Subcriptions</p>
                </Box>
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <img
                    ...
                    src="https://yt3.ggpht.com/BTEmw_5MEkux7TfyZli7LQA2cUY96tyvCgY7492DULsTzs9syfJB5y7SGjchjCkezcW0Xq1M=s88-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </Box>
                <Box>
                  <p className="text-white">Damit2k</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <img
                    className="w-[25px] rounded-full"
                    src="https://yt3.ggpht.com/ux6IbjY66j8gr8n-71aY9hwR1OGPmxweHWEYsDr-RxX_VbX1cZoReGi1JyKN-fDJ7h-Mqqn_Gw=s88-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </Box>
                <Box className="text-white">
              ...
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <img
                    className="w-[25px] rounded-full"
                    src="https://yt3.ggpht.com/JGA_RA-FOWLe3Lnw_-NKO8Gg2coVWUR0Czec-v3zmQ9_dDhn37g1RUFJMD1C8uv94snxumSejw=s88-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </Box>
                <Box>
                  <p className="text-white">Bomman</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <img
                    className="w-[25px] rounded-full"
                    src="https://yt3.googleusercontent.com/BxY7p578-b9oDyQK1FwlKSW_OUf3bAhw38Frttuwv8VY8u4Wg9UXvMJCgFEfFHEqC9_IUISHOg=s176-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </Box>
                <Box>
                  <p className="text-white">bienghe</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <img
                    className="w-[25px] rounded-full"
                    src="https://yt3.googleusercontent.com/ytc/AIdro_l-AmGtKwgVS92LHL6hao-W6cOfSLA7KNaasqfb3BSufBeo=s176-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </Box>
                <Box>
                  <p className="text-white">my20s</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
            ...
            <Box className="flex-col mt-4 text-lg ">
              <Box className="flex ml-[15px] gap-4">
                <Box>
                  <p className="text-white font-bold ml-3">Explore</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
            ...
            <Box className="flex-col mt-4 text-lg ">
              <Box className="flex ml-[15px] gap-4">
                <Box>
                  <p className="text-white font-bold ml-3">More from YouTube</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[8px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl items-center">
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ...
                    <g fill="none" fillRule="evenodd">
                      ...
                      <g fillRule="nonzero">
                        ...
                        <path
                          fill="#FFF"
                          fillOpacity=".2"
                          d="M22.54 7.6s-.2-1.5-.86-2.17c-.83-.87-1.75-.88-2.18-.93-3.04-.22-7.6-.2-7.6-.2s-4.56-.02-7.6.2c-.43.05-1.35.05-2.18.93-.65.66-.86 2.17-.86 2.17s.22 1.78.23 3.55v-.1c0-1.8-.23-3.56-.23-3.56z"
                        />
                        <path
                          fill="#3E2723"
                          fillOpacity=".2"
                ...
                <Box>
                  <p className="text-white">Youtube Premium</p>
                </Box>
              </Box>

              <Box className="flex ml-[25px] gap-[8px] items-center text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
              ...
              <Box className="flex ml-[25px] gap-[8px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
              ...
              <Box className="flex ml-[25px] gap-[8px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                ...
                <Box>
                  <p className="text-white">Youtube Kids</p>
                </Box>
              </Box>
            </Box>
            <hr className="  ##222222  mt-4" />
            <Box className="flex-col mt-4 text-lg ">
              ...
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                ...
                <Box>
                  <p className="text-white">Helps</p>
                </Box>
              </Box>
              <Box className="flex ml-[25px] gap-[20px] align-middle text-[15px] mt-[5px] bg-[#000000] w-[80%] hover:bg-[#222222] px-[8px] py-[5px] rounded-xl">
                <Box>
            ...
            <hr className="  ##222222  mt-4 " />
            <Box className="flex-col mt-4 text-lg mb-[160px] ">
              <Box className="flex ml-[15px] gap-4">
                <Box>
                  <p className="text-white font-bold ml-3">More from YouTube</p>
                </Box>
              </Box>
              <Box className=" ml-[25px] gap-[20px] align-middle text-[13px] mt-[5px] font-medium text-[#aaa]  w-[80%] px-[8px] py-[5px] rounded-xl">
                <Box className="flex gap-[6px] leading-[1rem]">
                  <a>About</a>
                  <a>Press</a>
                  <a>Copyright</a>
                </Box>
                <Box className="flex gap-[5px] leading-[1rem] ">
                  <a>Contact us</a>
                  <a>Creators</a>
                </Box>
                <Box className="flex gap-[5px] leading-[1rem]">
              ...
              <Box className="ml-[25px] gap-[20px] align-middle text-[13px] mt-[5px] font-medium text-[#aaa]  w-[80%] px-[8px] py-[5px] rounded-xl">
                ...
                <Box className="flex gap-[5px] leading-[1rem] mt-7 text-[#717171]">
                  <p>© 2024 Google LLC</p>
                </Box>
              </Box>
            </Box>
        ...
        <Col span={24} className=" pl-[130px] text-white  w-100% ">
          <Carousel
            className="w-[1200px] ml-[100px] fixed"
            arrows
            dotPosition="left"
            slidesToShow={10}
            slidesToScroll={1}
          ...
          >
            ...
            <div>
              <h3 style={contentStyle}>Valorant</h3>
            </div>
            <div>
            ...
            <div>
              <h3 style={contentStyle}>Esport</h3>
            </div>
            <div>
            ...
            <div>
              <h3 style={contentStyle}>Mixes</h3>
            </div>
            <div>
          ...
          <Box className="pl-[100px] pt-5 overflow-x-hidden">
            <VideoList/>
          </Box>
        </Col>
      </Row>
