...
const handleBlur = () => {
  ...
  return (
    <div className='fixed z-50 flex justify-between items-center pt-6 px-[1rem] py-[3rem] bg-[#0F0F0F] h-[10vh] w-full'>
  <div className='flex'>
  ...
  <div className='absolute right-0 mr-10 flex justify-around items-center'>
    ...
    <img className='rounded-full border  w-[40px] h-[40px] object-contain mx-[10px]' src=''alt='ava'/>
</div>
